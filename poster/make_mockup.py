...
panel(dx2, data_y, colw, ph_rt, "⑥ 注入試験 (In vitro & In vivo)〔新〕",
      ...
      C_VIVO, bar=C_VIVO_BAR, fig="図: in vitro 注入写真 / in vivo マウス皮下デポ写真", fig_h=ph_rt-78)
panel(dx2, data_y+ph_rt+gap, colw, ph_rb, "⑦ In vivo 組織学的評価 H&E染色〔考察・新〕",
      ...
      C_VIVO, bar=C_VIVO_BAR,
      fig="図: 実験スキーム / Optical(デポ) / H&E組織像 (Native vs PG4-025 ×0・5・14日)", fig_h=ph_rb-105)
